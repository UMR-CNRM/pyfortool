...
USE MODE_MNH_HIPFORT
    ...
    IF (GFIRST_CALL_MNH_ALLOC_ZWORK) THEN
       ...
       ! Work array
       ! 
       CALL MNH_HIPALLOCATE (ZPSRC_HALO2_WEST,IJU,IKU) 
       CALL MNH_HIPALLOCATE (ZPSRC_HALO2_SOUTH,IIU,IKU) 
       !$acc enter data create(ZPSRC_HALO2_WEST,ZPSRC_HALO2_SOUTH)

       CALL MNH_HIPALLOCATE (ZUNIT3D,IIU,IJU,IKU)
...
!----- Real pool
       ...
       !MODEL(1)%X => ZT3D_A1
       !ZT3D => MODEL(1)%X
       CALL MNH_HIPALLOCATE (ZT3D,IIU,IJU,IKU,JPMAX_T3D)
       !$acc enter data create(ZT3D)

       CALL MNH_HIPALLOCATE (ZT1D_OSIZE,0)
       CALL MNH_HIPALLOCATE (ZT2D_OSIZE,IIU,0)
       CALL MNH_HIPALLOCATE (ZT3D_OSIZE,IIU,IJU,0)
       CALL MNH_HIPALLOCATE (ZT4D_OSIZE,IIU,IJU,IKU,0)
...
!------ Logical pool
       ...
       CALL MNH_HIPALLOCATE (GT3D,IIU,IJU,IKU,JPMAX_T3D_G)
       !$acc enter data create(GT3D)

       CALL MNH_HIPALLOCATE (GT2D_OSIZE,IIU,0)
...
!------ Integer pool
       ...
       CALL MNH_HIPALLOCATE (IT3D,IIU,IJU,IKU,JPMAX_T3D_I)
...
!------ Real 1D pool 
       ...
       CALL MNH_HIPALLOCATE (ZT1D,IIU*IJU*IKU,JPMAX_T1D_R)
...
!------ Integer 1D pool
       ...
       CALL MNH_HIPALLOCATE (IT1D,IIU*IJU*IKU,JPMAX_T1D_I)
       CALL MNH_HIPALLOCATE (IT1D_OSIZE,0)
...
!------ Logical 1DFLAT pool
       ...
       CALL MNH_HIPALLOCATE( GT1DFLAT,NT1DFLAT_MAXSIZE_G)
...
!------ Integer 1DFLAT pool
       ...
       CALL MNH_HIPALLOCATE( IT1DFLAT,NT1DFLAT_MAXSIZE_I)
...
!------ Real 1DFLAT pool
       ...
       CALL MNH_HIPALLOCATE( ZT1DFLAT,NT1DFLAT_MAXSIZE_R)
