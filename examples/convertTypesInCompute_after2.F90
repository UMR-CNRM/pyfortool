...
!
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_MAX
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_MIN
INTEGER :: NPARAM_LIMA_MIXEDGAMINC
REAL :: XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MAX
REAL :: XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MIN
REAL :: XPARAM_LIMA_MIXEDACCLBDAR_MAX
REAL :: XPARAM_LIMA_MIXEDACCLBDAR_MIN
REAL :: XPARAM_LIMA_MIXEDSCLBDAS_MAX
REAL :: XPARAM_LIMA_MIXEDSCLBDAS_MIN
INTEGER :: NPARAM_LIMA_COLDSCLBDAS
REAL :: XPARAM_LIMA_COLDSCLBDAI_MAX
REAL :: XPARAM_LIMA_COLDSCLBDAI_MIN
INTEGER :: NPARAM_LIMA_COLDSCLBDAI
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMAX
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMIN
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMAX
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMIN
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMAX
REAL :: XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMIN
REAL :: XPARAM_LIMA_MIXEDDRYLBDAR_MAX
REAL :: XPARAM_LIMA_MIXEDDRYLBDAR_MIN
INTEGER :: NPARAM_LIMA_MIXEDDRYLBDAR
REAL :: XPARAM_LIMA_MIXEDDRYLBDAS_MAX
REAL :: XPARAM_LIMA_MIXEDDRYLBDAS_MIN
INTEGER :: NPARAM_LIMA_MIXEDDRYLBDAS
REAL :: XPARAM_LIMA_MIXEDDRYLBDAG_MAX
REAL :: XPARAM_LIMA_MIXEDDRYLBDAG_MIN
INTEGER :: NPARAM_LIMA_MIXEDDRYLBDAG
REAL :: XPARAM_LIMA_MIXEDWETLBDAS_MAX
REAL :: XPARAM_LIMA_MIXEDWETLBDAS_MIN
INTEGER :: NPARAM_LIMA_MIXEDWETLBDAS
REAL :: XPARAM_LIMA_MIXEDWETLBDAG_MAX
REAL :: XPARAM_LIMA_MIXEDWETLBDAG_MIN
INTEGER :: NPARAM_LIMA_MIXEDWETLBDAG
REAL :: XPARAM_LIMA_MIXEDWETLBDAH_MAX
REAL :: XPARAM_LIMA_MIXEDWETLBDAH_MIN
INTEGER :: NPARAM_LIMA_MIXEDWETLBDAH
...
!
!ILUOUT0 = TLUOUT0%NLU
NPARAM_LIMA_MIXEDWETLBDAH=PARAM_LIMA_MIXED%NWETLBDAH
XPARAM_LIMA_MIXEDWETLBDAH_MIN=PARAM_LIMA_MIXED%XWETLBDAH_MIN
XPARAM_LIMA_MIXEDWETLBDAH_MAX=PARAM_LIMA_MIXED%XWETLBDAH_MAX
NPARAM_LIMA_MIXEDWETLBDAG=PARAM_LIMA_MIXED%NWETLBDAG
XPARAM_LIMA_MIXEDWETLBDAG_MIN=PARAM_LIMA_MIXED%XWETLBDAG_MIN
XPARAM_LIMA_MIXEDWETLBDAG_MAX=PARAM_LIMA_MIXED%XWETLBDAG_MAX
NPARAM_LIMA_MIXEDWETLBDAS=PARAM_LIMA_MIXED%NWETLBDAS
XPARAM_LIMA_MIXEDWETLBDAS_MIN=PARAM_LIMA_MIXED%XWETLBDAS_MIN
XPARAM_LIMA_MIXEDWETLBDAS_MAX=PARAM_LIMA_MIXED%XWETLBDAS_MAX
NPARAM_LIMA_MIXEDDRYLBDAG=PARAM_LIMA_MIXED%NDRYLBDAG
XPARAM_LIMA_MIXEDDRYLBDAG_MIN=PARAM_LIMA_MIXED%XDRYLBDAG_MIN
XPARAM_LIMA_MIXEDDRYLBDAG_MAX=PARAM_LIMA_MIXED%XDRYLBDAG_MAX
NPARAM_LIMA_MIXEDDRYLBDAS=PARAM_LIMA_MIXED%NDRYLBDAS
XPARAM_LIMA_MIXEDDRYLBDAS_MIN=PARAM_LIMA_MIXED%XDRYLBDAS_MIN
XPARAM_LIMA_MIXEDDRYLBDAS_MAX=PARAM_LIMA_MIXED%XDRYLBDAS_MAX
NPARAM_LIMA_MIXEDDRYLBDAR=PARAM_LIMA_MIXED%NDRYLBDAR
XPARAM_LIMA_MIXEDDRYLBDAR_MIN=PARAM_LIMA_MIXED%XDRYLBDAR_MIN
XPARAM_LIMA_MIXEDDRYLBDAR_MAX=PARAM_LIMA_MIXED%XDRYLBDAR_MAX
XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMIN=PARAM_LIMA_MIXED%XGAMINC_BOUND_RDSF_RMIN
XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_RDSF_RMAX
XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMIN=PARAM_LIMA_MIXED%XGAMINC_BOUND_CIBU_GMIN
XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_CIBU_GMAX
XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMIN=PARAM_LIMA_MIXED%XGAMINC_BOUND_CIBU_SMIN
XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_CIBU_SMAX
NPARAM_LIMA_COLDSCLBDAI=PARAM_LIMA_COLD%NSCLBDAI
XPARAM_LIMA_COLDSCLBDAI_MIN=PARAM_LIMA_COLD%XSCLBDAI_MIN
XPARAM_LIMA_COLDSCLBDAI_MAX=PARAM_LIMA_COLD%XSCLBDAI_MAX
NPARAM_LIMA_COLDSCLBDAS=PARAM_LIMA_COLD%NSCLBDAS
XPARAM_LIMA_MIXEDSCLBDAS_MIN=PARAM_LIMA_MIXED%XSCLBDAS_MIN
XPARAM_LIMA_MIXEDSCLBDAS_MAX=PARAM_LIMA_MIXED%XSCLBDAS_MAX
XPARAM_LIMA_MIXEDACCLBDAR_MIN=PARAM_LIMA_MIXED%XACCLBDAR_MIN
XPARAM_LIMA_MIXEDACCLBDAR_MAX=PARAM_LIMA_MIXED%XACCLBDAR_MAX
XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MIN=PARAM_LIMA_MIXED%XGAMINC_HMC_BOUND_MIN
XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MAX=PARAM_LIMA_MIXED%XGAMINC_HMC_BOUND_MAX
NPARAM_LIMA_MIXEDGAMINC=PARAM_LIMA_MIXED%NGAMINC
XPARAM_LIMA_MIXEDGAMINC_BOUND_MIN=PARAM_LIMA_MIXED%XGAMINC_BOUND_MIN
XPARAM_LIMA_MIXEDGAMINC_BOUND_MAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_MAX
...
XPARAM_LIMA_MIXEDGAMINC_BOUND_MAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_MAX
ZRATE = EXP(LOG(XPARAM_LIMA_MIXEDGAMINC_BOUND_MAX/XPARAM_LIMA_MIXEDGAMINC_BOUND_MIN)/FLOAT(NPARAM_LIMA_MIXEDGAMINC-1))
!
...
!
DO I1=1,NGAMINC
  ZBOUND = XPARAM_LIMA_MIXEDGAMINC_BOUND_MIN*ZRATE**(I1-1)
...
XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MAX=PARAM_LIMA_MIXED%XGAMINC_HMC_BOUND_MAX
ZRATE = EXP(LOG(XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MAX/XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MIN)/REAL(NPARAM_LIMA_MIXEDGAMINC-1))
!
CALL PARAM_LIMA_MIXED_ALLOCATE('XGAMINC_HMC', NGAMINC)
!
DO I1=1,NGAMINC
  ZBOUND = XPARAM_LIMA_MIXEDGAMINC_HMC_BOUND_MIN*ZRATE**(I1-1)
...
XPARAM_LIMA_MIXEDACCLBDAR_MAX=PARAM_LIMA_MIXED%XACCLBDAR_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDACCLBDAR_MAX/XPARAM_LIMA_MIXEDACCLBDAR_MIN)/REAL(NACCLBDAR-1)
XACCINTP1R = 1.0 / ZRATE
XACCINTP2R = 1.0 - LOG( XPARAM_LIMA_MIXEDACCLBDAR_MIN ) / ZRATE
!
...
XPARAM_LIMA_MIXEDSCLBDAS_MAX=PARAM_LIMA_MIXED%XSCLBDAS_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDSCLBDAS_MAX/XPARAM_LIMA_MIXEDSCLBDAS_MIN)/FLOAT(NPARAM_LIMA_COLDSCLBDAS-1)
XSCINTP1S = 1.0 / ZRATE
...
XPARAM_LIMA_COLDSCLBDAI_MAX=PARAM_LIMA_COLD%XSCLBDAI_MAX
ZRATE = LOG(XPARAM_LIMA_COLDSCLBDAI_MAX/XPARAM_LIMA_COLDSCLBDAI_MIN)/FLOAT(NPARAM_LIMA_COLDSCLBDAI-1)
XSCINTP1I = 1.0 / ZRATE
...
XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_CIBU_SMAX
ZRATE_S = EXP(LOG(XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMAX/XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMIN)/&
              FLOAT(NPARAM_LIMA_MIXEDGAMINC-1))
!
...
XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_CIBU_GMAX
ZRATE_G = EXP(LOG(XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMAX/XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMIN)/&
              FLOAT(NPARAM_LIMA_MIXEDGAMINC-1))
!
...
!
DO I1 = 1, NGAMINC
  ZBOUND_CIBU_SMIN = XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_SMIN * ZRATE_S**(I1-1)
  ZBOUND_CIBU_GMIN = XPARAM_LIMA_MIXEDGAMINC_BOUND_CIBU_GMIN * ZRATE_G**(I1-1)
!
! For ZNI_CIBU
...
XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMAX=PARAM_LIMA_MIXED%XGAMINC_BOUND_RDSF_RMAX
ZRATE_R = EXP(LOG(XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMAX/XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMIN)/&
              FLOAT(NPARAM_LIMA_MIXEDGAMINC-1))
!
CALL PARAM_LIMA_MIXED_ALLOCATE('XGAMINC_RDSF_R', NGAMINC)
!
DO I1 = 1, NGAMINC
  ZBOUND_RDSF_RMIN = XPARAM_LIMA_MIXEDGAMINC_BOUND_RDSF_RMIN * ZRATE_R**(I1-1)
!
! For ZNI_RDSF
...
XPARAM_LIMA_MIXEDDRYLBDAR_MAX=PARAM_LIMA_MIXED%XDRYLBDAR_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDDRYLBDAR_MAX/XPARAM_LIMA_MIXEDDRYLBDAR_MIN)/REAL(NPARAM_LIMA_MIXEDDRYLBDAR-1)
...
XPARAM_LIMA_MIXEDDRYLBDAS_MAX=PARAM_LIMA_MIXED%XDRYLBDAS_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDDRYLBDAS_MAX/XPARAM_LIMA_MIXEDDRYLBDAS_MIN)/REAL(NPARAM_LIMA_MIXEDDRYLBDAS-1)
...
XPARAM_LIMA_MIXEDDRYLBDAG_MAX=PARAM_LIMA_MIXED%XDRYLBDAG_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDDRYLBDAG_MAX/XPARAM_LIMA_MIXEDDRYLBDAG_MIN)/REAL(NPARAM_LIMA_MIXEDDRYLBDAG-1)
XDRYINTP1G = 1.0 / ZRATE
XDRYINTP2G = 1.0 - LOG( XPARAM_LIMA_MIXEDDRYLBDAG_MIN ) / ZRATE
!
...
XPARAM_LIMA_MIXEDWETLBDAS_MAX=PARAM_LIMA_MIXED%XWETLBDAS_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDWETLBDAS_MAX/XPARAM_LIMA_MIXEDWETLBDAS_MIN)/REAL(NPARAM_LIMA_MIXEDWETLBDAS-1)
XWETINTP1S = 1.0 / ZRATE
XWETINTP2S = 1.0 - LOG( XPARAM_LIMA_MIXEDWETLBDAS_MIN ) / ZRATE
...
XPARAM_LIMA_MIXEDWETLBDAG_MAX=PARAM_LIMA_MIXED%XWETLBDAG_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDWETLBDAG_MAX/XPARAM_LIMA_MIXEDWETLBDAG_MIN)/REAL(NPARAM_LIMA_MIXEDWETLBDAG-1)
...
XPARAM_LIMA_MIXEDWETLBDAH_MAX=PARAM_LIMA_MIXED%XWETLBDAH_MAX
ZRATE = LOG(XPARAM_LIMA_MIXEDWETLBDAH_MAX/XPARAM_LIMA_MIXEDWETLBDAH_MIN)/REAL(NPARAM_LIMA_MIXEDWETLBDAH-1)
XWETINTP1H = 1.0 / ZRATE
XWETINTP2H = 1.0 - LOG( XPARAM_LIMA_MIXEDWETLBDAH_MIN ) / ZRATE
!
