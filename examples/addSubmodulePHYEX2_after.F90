...
IMPLICIT NONE
INTERFACE
MODULE SUBROUTINE ICE4_SEDIMENTATION_SPLIT(D, CST, ICEP, ICED, PARAMI, &
                                   &PTSTEP, KRR, PDZZ, &
...
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(INOUT) :: PRRS
...
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(INOUT) :: PRSS
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(IN) :: PRST
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(INOUT) :: PRGS
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(IN) :: PRGT
REAL, DIMENSION(D%NIJT), INTENT(OUT) :: PINPRC
REAL, DIMENSION(D%NIJT), INTENT(OUT) :: PINPRR
REAL, DIMENSION(D%NIJT), INTENT(OUT) :: PINPRI
REAL, DIMENSION(D%NIJT), INTENT(OUT) :: PINPRS
REAL, DIMENSION(D%NIJT), INTENT(OUT) :: PINPRG
REAL, DIMENSION(D%NIJT), INTENT(IN), OPTIONAL :: PSEA
REAL, DIMENSION(D%NIJT), INTENT(IN), OPTIONAL :: PTOWN
REAL, DIMENSION(D%NIJT), INTENT(OUT), OPTIONAL :: PINPRH
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(IN), OPTIONAL :: PRHT
REAL, DIMENSION(D%NIJT, D%NKT), INTENT(INOUT), OPTIONAL :: PRHS
REAL, DIMENSION(D%NIJT, D%NKT, KRR), INTENT(OUT), OPTIONAL :: PFPR
...
!-----------------------------------------------------------------
SUBMODULE (MODE_ICE4_SEDIMENTATION_SPLIT) SMODE_ICE4_SEDIMENTATION_SPLIT
IMPLICIT NONE
CONTAINS
MODULE SUBROUTINE ICE4_SEDIMENTATION_SPLIT(D, CST, ICEP, ICED, PARAMI, &
                                   &PTSTEP, KRR, PDZZ, &
...
END SUBMODULE SMODE_ICE4_SEDIMENTATION_SPLIT
