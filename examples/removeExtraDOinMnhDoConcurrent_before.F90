!#PYFT transfo: --removeExtraDOinMnhDoConcurrent
...
INTEGER :: IKTB, IKTE, IKB, IKL, IIJE, IIJB, JTOTO
REAL(KIND=JPHOOK) :: ZHOOK_HANDLE
!
...
!$mnh_do_concurrent(JIJ=IIJB:IIJE , JK=IKTB:IKTE, JTOTO=IKTOTO:IKTOTO2 )
   DO JK = IKTB , IKTE
    DO JIJ = IIJB, IIJE
     DO JTOTO = IKTOTO,IKTOTO2
