...
IMPLICIT NONE
INTERFACE
MODULE SUBROUTINE DYF2D_PHY(D,PA,PDYF)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
USE MODD_PARAMETERS, ONLY: JPHEXT
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PDYF
END SUBROUTINE DYF2D_PHY
MODULE SUBROUTINE DYF_PHY(D,PA,PDYF)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
USE MODD_PARAMETERS, ONLY: JPHEXT
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PDYF
END SUBROUTINE DYF_PHY
MODULE SUBROUTINE DYM2D_PHY(D,PA,PDYM)
USE MODD_PARAMETERS, ONLY: JPHEXT
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PDYM
END SUBROUTINE DYM2D_PHY
MODULE SUBROUTINE DYM_PHY(D,PA,PDYM)
USE MODD_PARAMETERS, ONLY: JPHEXT
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PDYM
END SUBROUTINE DYM_PHY
MODULE SUBROUTINE DXM2D_PHY(D,PA,PDXM)
USE MODD_PARAMETERS, ONLY: JPHEXT
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PDXM
END SUBROUTINE DXM2D_PHY
MODULE SUBROUTINE DXM_PHY(D,PA,PDXM)
USE MODD_PARAMETERS, ONLY: JPHEXT
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PDXM
END SUBROUTINE DXM_PHY
MODULE SUBROUTINE DXF2D_PHY(D,PA,PDXF)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
USE MODD_PARAMETERS, ONLY: JPHEXT
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PDXF
END SUBROUTINE DXF2D_PHY
MODULE SUBROUTINE DXF_PHY(D,PA,PDXF)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
USE MODD_PARAMETERS, ONLY: JPHEXT
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PDXF
END SUBROUTINE DXF_PHY
MODULE SUBROUTINE DZF_PHY(D,PA,PDZF)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PDZF
END SUBROUTINE DZF_PHY
MODULE SUBROUTINE MYF2D_PHY(D,PA,PMYF)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PMYF
END SUBROUTINE MYF2D_PHY
MODULE SUBROUTINE MYF_PHY(D,PA,PMYF)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PMYF
END SUBROUTINE MYF_PHY
MODULE SUBROUTINE MXF2D_PHY(D,PA,PMXF)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PMXF
END SUBROUTINE MXF2D_PHY
MODULE SUBROUTINE MXF_PHY(D,PA,PMXF)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PMXF
END SUBROUTINE MXF_PHY
MODULE SUBROUTINE MZF_PHY(D,PA,PMZF)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PMZF
END SUBROUTINE MZF_PHY
MODULE SUBROUTINE DZM_PHY(D,PA,PDZM)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PDZM
END SUBROUTINE DZM_PHY
MODULE SUBROUTINE MYM_PHY(D,PA,PMYM)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PMYM
END SUBROUTINE MYM_PHY
MODULE SUBROUTINE MYM2D_PHY(D,PA,PMYM)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PMYM
END SUBROUTINE MYM2D_PHY
MODULE SUBROUTINE MZM_PHY(D,PA,PMZM)
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PMZM
END SUBROUTINE MZM_PHY
MODULE SUBROUTINE MXM2D_PHY(D,PA,PMXM)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT), INTENT(OUT) :: PMXM
END SUBROUTINE MXM2D_PHY
MODULE SUBROUTINE MXM_PHY(D,PA,PMXM)
USE MODD_PARAMETERS
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_t
IMPLICIT NONE
TYPE(DIMPHYEX_t), INTENT(IN) :: D
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(IN) :: PA
REAL, DIMENSION(D%NIT, D%NJT, D%NKT), INTENT(OUT) :: PMXM
END SUBROUTINE MXM_PHY
END INTERFACE
END MODULE MODE_SHUMAN_PHY

!#PYFT transfo: --addSubmodulePHYEX

SUBMODULE (MODE_SHUMAN_PHY) SMODE_SHUMAN_PHY
IMPLICIT NONE
CONTAINS
!     ###############################
      MODULE SUBROUTINE MXM_PHY(D,PA,PMXM)
...
END SUBMODULE SMODE_SHUMAN_PHY
